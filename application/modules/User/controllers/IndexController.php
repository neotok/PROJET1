...
class User_IndexController extends Ip_Controller_Action
{
	...
	*deleteAction
     ...
     public function deleteAction()
	 {
		...
		$this->_redirect( $this->_helper->url->url( array(), 'userList' ), array( 'exit' => false));
	 }
			...
			if( $form->isValid( $this->getRequest()->getPost() ) ){
				...
				switch( $result ){
					...
					default:
						...
						$form->reset();
						$this->_redirect( $this->_helper->url->url( array('id' => $result), 'userById' ), array( 'exit' => false));
						break;
				}
			} else {
	 ...
	 public function editAction()
	 {
	 	$id 			= (int) $this->getRequest()->getParam('id');
	  	...
	  	if( !$user instanceof User_Model_User){
	  		...
	  		$this->_redirect( '/User/index/list', array( 'exit' => false) );
	  	}
				...
				if( $form->isValid( $this->getRequest()->getPost() ) ){
					...
					switch( $result ){
						case User_Service_User::USER_AUTH_SUCCESS :
							$this->addSystemSuccess('Connecte');
							$form->reset();
							$this->_redirect( $sessionRequest->previous, array( 'exit' => false, 'code' => 301 ));
							break;
						default :
							$this->addSystemError('Echec de la connexion');
							$this->_redirect($sessionRequest->previous, array( 'exit' => false));
							break;
					}
				} else {
	...
	*logoutAction
     ...
     public function logoutAction()
	 {
		...
		$this->_redirect( $this->_helper->url->url( array(), 'index' ), array( 'exit' => false));
	 }
}
